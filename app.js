...
const packing = {
  ...
  shared: {
    ...
    "Praktiskt": ["Reseadaptrar för brittiska vägguttag – 2 st", "Värktabletter – 1 förpackning", "Skavsårsplåster – 1 förpackning", "Myggmedel – 1 st", "Tvättsäckar – 2 st", "Liten dagryggsäck – 1 st", "Bagagevåg – 1 st"],
